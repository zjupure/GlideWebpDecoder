...
[![Release Version](https://img.shields.io/badge/release-1.4-red.svg)](https://github.com/zjupure/GlideWebpDecoder/releases)
...
For example, if you use glide 4.9.0, the corresponding version of GlideWebpDecoder should be 1.4.4.9.0
